...
uint8_t userial_vendor_get_baud()
{
    return cfgetospeed(&vnd_userial.termios);
}
/*******************************************************************************
**
...
**
*******************************************************************************/
uint16_t userial_vendor_write(uint8_t *p_data, uint16_t len)
{
    int ret, total = 0;
...
void userial_vendor_enable_CTSRTS(uint8_t enable)
{
    if (enable)
    {
        tcgetattr(vnd_userial.fd, &vnd_userial.termios);
