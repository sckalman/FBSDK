  ...
  SOURCE_PPPOE_CONF_DIR := device/rockchip/common/pppoe/configs
  ...
  SOURCE_PPPOE_SCRIPT_DIR := device/rockchip/common/pppoe/scripts
  ...
  SOURCE_PPPOE_BIN_DIR := device/rockchip/common/pppoe/bin
